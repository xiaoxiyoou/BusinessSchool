  ...
  <div class="container">
    ...
    <div class="programContent">
      <div class="content">
        <div
          class="item"
          @click="toOfflineDetail(item.OfflineCourseId)"
        ...
        >
          ...
          <div class="descCon row j-b">
            <span class="desc"
              >活动时间：{{ item.StartTime }}-{{ item.EndTime }}</span
            >
...
import { getApplyList } from 'api/index'
